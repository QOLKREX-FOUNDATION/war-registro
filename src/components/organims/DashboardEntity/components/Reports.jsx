...
import { PetTableReport } from "./PetTableReport";
...
export const Reports = () => {
      ...
      setDefaultUser([
        {
          ...
          value: `${entityRegister[0]?.name} - ${entityRegister[0]?.lastName}`,
        },
      ]);
  ...
  const handleGenerateReport = async () => {
    try {
      ...
      console.log(filterEntity[0]?.label);
      // const response = await fetch(
      //   "https://firulaix-api-test.vercel.app/api/reports/create-report",
      //   {
      ...
      // const response = await fetch(
      //   "http://localhost:5000/api/reports/create-report-entity",
      //   {
      //     method: "POST",
      //     headers: {
      ...
      // const arrayBuffer = new Uint8Array(await Promise.all(chunks)).buffer;
  ...
  return (
    <div className="flex flex-col">
      ...
      <h2 className="text-xl font-semibold">
        Elija los campos que desea generar el reporte Entidad:
      </h2>
      <div
      ...
      >
        ...
        {/* <div className="flex flex-row gap-3">
          <div className="flex flex-col gap-2 h-[355px] w-1/2">
            <div className="flex flex-col gap-2 w-80">
              <h2 className="text-xl font-semibold">Filtros de Fecha</h2>
              {watch("choose_date") ? (
            ...
            <div className="flex flex-col">
              <h2 className="text-xl font-semibold">Filtros de Ubicación</h2>
          ...
          <div className="flex flex-col gap-2 h-[355px] w-1/2 px-2">
        ...
        {/* <div className="flex flex-col justify-end">
          <button
            ...
            className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-md disabled:opacity-50 flex justify-center items-center gap-2 disabled:cursor-not-allowed"
          >
