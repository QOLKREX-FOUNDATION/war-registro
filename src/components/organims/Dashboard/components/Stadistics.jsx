        ...
        <>
            {
                statistic?.petsWithRegisteringEntity ? (
                    <div className='flex flex-col'>
                        <h2 className='text-xl font-semibold py-2'>Estadísticas Generales:</h2>
                        <div className='flex flex-row flex-wrap items-center gap-16'>
                            <div className="flex flex-col w-1/3 md:min-w-[200px] min-w-full">
                                <h2 className='py-1 pb-10 font-bold'>Mascotas Según la entidad registradora:</h2>
                                <Doughnut data={petsByEntity} />
                            </div>
                            <div className="flex flex-col w-2/3 md:min-w-[200px] max-w-[500px] min-w-full">
                                <h2 className='py-1 pb-10 font-bold'>Usuarios según la entidad registradora:</h2>
                                    ...
                                    <div className="flex flex-col w-1/2">
                                        {
                                            adoptersByEntity?.labels.map((item, index) => (
                                                <div className="flex flex-col w-1/2 md:min-w-[200px] min-h-[60px] min-w-full" key={index}>
                                    ...
                                    <div className="flex flex-col w-1/2 ">
                                        {
                                            statistic?.userWithRegisteringEntity.map((item) => (
                                                <div className="flex flex-col w-1/2 md:min-w-[200px] min-h-[60px] min-w-full" key={item.label}>
                        ...
                        <h2 className='text-xl font-semibold py-2 pt-4'>Estadísticas según características de las Mascotas:</h2>
                        <div className='flex flex-row flex-wrap items-center justify-center'>
                            <div className="flex flex-col w-1/2 md:min-w-[200px] min-h-[200px] min-w-full">
                                <h2 className='py-1'>Mascotas Según el mes ({new Date().getFullYear()})</h2>
                                <Bar
                                    options={optionsBar}
                                    data={{
                                        ...
                                        datasets: [
                                            {
                                                label: "My First Dataset",
                                                data: statistic?.petsByMonthArray.map((item) => item.quantity),
                                                backgroundColor: [
                                                    "rgb(255, 99, 132)",
                                                    "rgb(54, 162, 235)",
                                                    "rgb(255, 205, 86)",
                            ...
                            <div className="flex flex-col w-1/2 md:min-w-[200px] min-h-[200px] min-w-full">
                                <h2 className='py-1'>Adopters según el mes ({new Date().getFullYear()})</h2>
                                <Bar
                                    options={optionsBar}
                                    data={{
                                        labels: statistic?.adoptersByMonthArray.map((item) => item.month),
                                        datasets: [
                                            {
                                                label: "My First Dataset",
                                                data: statistic?.adoptersByMonthArray.map((item) => item.quantity),
                                                backgroundColor: [
                                                    "rgb(255, 99, 132)",
                                                    "rgb(54, 162, 235)",
                                                    "rgb(255, 205, 86)",
                                ...
                                <Bar
                                    ...
                                    data={{
                                        ...
                                        datasets: [
                                            {
                                                label: "My First Dataset",
                                                data: statistic?.petsByBreedArray.map((item) => item.quantity),
                                                backgroundColor: [
                                                    "rgb(255, 99, 132)",
                                                    "rgb(54, 162, 235)",
                                                    "rgb(255, 205, 86)",
                                ...
                                <Bar
                                    ...
                                    data={{
                                        ...
                                        datasets: [
                                            {
                                                label: "My First Dataset",
                                                data: statistic?.petsByRaceArray.map((item) => item.quantity),
                                                backgroundColor: [
                                                    "rgb(255, 99, 132)",
                                                    "rgb(54, 162, 235)",
                                                    "rgb(255, 205, 86)",
