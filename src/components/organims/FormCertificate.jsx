...
export const FormCertificate = ({ formId, petValues, adopter }) => {
    ...
    useEffect(() => {
        ...
        setLoading(false);
        firuApi.get(`/form/search/id/${ formId }`, {
    ...
    return (
        ...
        <>
            {
                !loading ? <div className="text-center dark:text-white text-lg">Cargando...</div> :
                    <>
                        {
                            (formId === "" || formId === undefined || form === undefined || form.length === 0)
                                ? <div className="text-center dark:text-white text-lg">No hay datos</div>
                                :
                                <FormPrint selectedForm={
                                    {
                                        ...
                                        pet: {
                                            ...
                                            isSterilized: petValues.sterilized === 'NO' ? 'isSterilized-no' : 'isSterilized-yes',
                                        ...
                                        adopter: {
                                            ...
                                            birthDate: form?.adopter?.birthDate,
