    ...
    <div className={classes.container}>
      ...
      >
        ...
        <img
          ...
          // src={`https://firulaixcoin.money/images/logos/${ petValues?.idRegisteringEntity }.png`}
        ...
        <p
          className={`${classes.text} ${classes.signature} ${
            imp && !impComplete ? classes.opacity : ""
          }`}
          style={{
            borderTop: `${imp ? 3 : ajust.height / 300}px solid #E5BB00`,
            fontSize: imp ? "17px" : ajust.height / 80,
        ...
        <p
          className={`${classes.text} ${classes.signatureEr} ${
            imp && !impComplete ? classes.opacity : ""
          }`}
          style={{
            borderTop: `${imp ? 3 : ajust.height / 300}px solid #E5BB00`,
        ...
        <p
          className={`${classes.text} ${classes.textOne} ${
            imp && !impComplete ? classes.opacity : ""
          }`}
          style={{ fontSize: imp ? "17px" : ajust.height / 65 }}
        >
        ...
        <p
          className={`${classes.text} ${classes.textTwo} ${
            imp && !impComplete ? classes.opacity : ""
          }`}
        ...
        <p
          className={`${classes.text} ${classes.textThree} ${
            imp && !impComplete ? classes.opacity : ""
          }`}
        ...
        <p
          className={`${classes.text} ${classes.website} ${
            imp && !impComplete ? classes.opacity : ""
          }`}
