...
export const DataSensitive = ({
	...
	const country = watchAdopter("country")
	useEffect(() => {
		console.log(country)
	}, [country])
				...
				<div className="col-span-2 grid grid-cols-2 gap-x-4 gap-y-5">
					...
					<div>
						<Input
							...
							onBlur={() => handleEmail(watchAdopter("email"), web3.authToken, watchAdopter("_id"))}
							id="email"
						/>
							...
							<>
								<div>
									<ReactSelect
										readOnly={readOnly}
										options={departments}
										value={{ label: watchAdopter("department") }}
										onChange={(target) => {
								...
								<div>
									<ReactSelect
										readOnly={readOnly}
										options={provinces}
										value={{ label: watchAdopter("province") }}
										onChange={(target) => {
								...
								<div>
									<ReactSelect
										readOnly={readOnly}
										options={districts}
										value={{ label: watchAdopter("district") }}
										onChange={(target) => {
